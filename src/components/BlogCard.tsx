...
export function BlogCard({ slug, lang, image, category, title, description, author, authorImage, date, dictionary }: BlogCardProps) {
    const initials = author ? author.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2) : 'A';
            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' }}>
                        <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: 'var(--accent-primary)', fontSize: '0.6rem', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: '#fff', overflow: 'hidden' }}>
                            {authorImage ? (
